...
class TrainerConfig:
    ...
    Difficulty_Adaptation: bool = False
    """是否开启Difficulty_Adaptation"""
    Varient_Num: Optional[int] = None
    """原样本+噪声样本的共同数量"""
    Difficulty_Change: bool = False
    """难度自适应变换"""
    Full_Vector_Data_Path: Optional[str] = None
    """Log路径"""
    Diffculty_Updates_Path: Optional[str] = None
    """Log路径2"""
