...
class DataParallelPPOCritic(BasePPOCritic):
    ...
    def compute_values(self, data: DataProto) -> torch.Tensor:
        ...
        if self.rank == 0:
            ...
            # micro_batches = tqdm(micro_batches, desc="Compute values", position=1, leave=False)
    ...
    def update_critic(self, data: DataProto) -> Dict[str, Any]:
        ...
        for _ in range(self.config.ppo_epochs):
            if self.rank == 0:
                ...
                # mini_batches = tqdm(mini_batches, desc="Train mini-batches", position=1, leave=False)
            ...
            for mini_batch in mini_batches:
                ...
                if self.rank == 0:
                    ...
                    # micro_batches = tqdm(micro_batches, desc="Update critic", position=2, leave=False)
